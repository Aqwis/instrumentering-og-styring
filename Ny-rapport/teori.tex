...
\begin{table}[h!]
\caption{Sammenligning mellom Arduino og Raspberry Pi\colorbox{yellow}{Kilde!}}
\centering
\begin{tabular}{ |c |c |c| }
	\hline
...
OpenCV er et softwarebibliotek med åpen kildekode som brukes til digital bildebehandling. Biblioteket i versjon 2.x, som er versjonen vi har benyttet oss av, er programmert i C++ og støtter mange ulikw plattformer. \cite{docs:opencv}

For å kunne bruke funksjoner fra OpenCV i Matlab måtte vi ta i bruk et verktøy som heter mexopencv. Matlab er ikke uten videre kompatibelt med OpenCV, da dette er programmert i C++. Mexopencv tilbyr Matlabfunksjoner som bygger på flere hundre APIer fra OpenCV. \cite{mexopencv} Dette tillater å programmere alt i Matlab, uten å måtte fokusere på hvordan OpenCV er bygget opp. 
